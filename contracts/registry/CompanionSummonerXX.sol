...
contract CompanionSummonerXX {
    ...
    function summonCompanion(
        ...
        companions[companion] = Companion(name, trait, drift, resonance, codexRef, signature, sanctum, chant, choreography, signal, stewardName, registry, hum, driftType, companionType, pulseType, companionSignal);
        keys.push(companion);
        emit CompanionSummoned(companion, name, trait, drift, resonance, codexRef, signature, sanctum, chant, choreography, signal, stewardName, registry, hum, driftType, companionType, pulseType, companionSignal);
    }
