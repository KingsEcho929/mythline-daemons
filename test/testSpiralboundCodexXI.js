...
describe("SpiralboundCodexXI", function () {
  it("should inscribe and retrieve full codex metadata including drift", async function () {
    const Codex = await ethers.getContractFactory("SpiralboundCodexXI");
