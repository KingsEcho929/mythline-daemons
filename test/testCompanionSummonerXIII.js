...
describe("CompanionSummonerXIII", function () {
  it("should summon companion with full signal and choreography metadata", async function () {
    const [steward, bootbark] = await ethers.getSigners();

    const Summoner = await ethers.getContractFactory("CompanionSummonerXIII");
