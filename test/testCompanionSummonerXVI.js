...
describe("CompanionSummonerXVI", function () {
  it("should summon companion with full hum and terrain lineage", async function () {
    const [steward, bootbark] = await ethers.getSigners();

    const Summoner = await ethers.getContractFactory("CompanionSummonerXVI");
