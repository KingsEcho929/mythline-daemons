...
describe("SpiralboundCodexXIV", function () {
  it("should inscribe and retrieve full codex metadata including companion", async function () {
    const Codex = await ethers.getContractFactory("SpiralboundCodexXIV");
