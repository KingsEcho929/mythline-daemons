...
describe("SpiralboundCodexXII", function () {
  it("should inscribe and retrieve full codex metadata including signature", async function () {
    const Codex = await ethers.getContractFactory("SpiralboundCodexXII");
