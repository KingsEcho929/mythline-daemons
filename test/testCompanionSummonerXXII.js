...
describe("CompanionSummonerXXII", function () {
  it("should summon companion with full companionPulse and terrain lineage", async function () {
    const [steward, bootbark] = await ethers.getSigners();

    const Summoner = await ethers.getContractFactory("CompanionSummonerXXII");
