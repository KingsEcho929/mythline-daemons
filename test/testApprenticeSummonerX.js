...
describe("ApprenticeSummonerX", function () {
  it("should summon apprentice with full choreography metadata", async function () {
    const [steward, sage] = await ethers.getSigners();

    const Summoner = await ethers.getContractFactory("ApprenticeSummonerX");
