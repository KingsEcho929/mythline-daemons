...
describe("ApprenticeSummonerXVIII", function () {
  it("should summon apprentice with full stewardSignal and terrain lineage", async function () {
    const [steward, sage] = await ethers.getSigners();

    const Summoner = await ethers.getContractFactory("ApprenticeSummonerXVIII");
