...
describe("SpiralboundCodexV9", function () {
  it("should inscribe and retrieve full codex metadata including chant", async function () {
    const Codex = await ethers.getContractFactory("SpiralboundCodexV9");
