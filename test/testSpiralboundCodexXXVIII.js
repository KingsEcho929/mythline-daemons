...
describe("SpiralboundCodexXXVIII", function () {
  it("should inscribe and retrieve full codex metadata including driftSignal", async function () {
    const Codex = await ethers.getContractFactory("SpiralboundCodexXXVIII");
