...
describe("SpiralboundCodexXVII", function () {
  it("should inscribe and retrieve full codex metadata including echo", async function () {
    const Codex = await ethers.getContractFactory("SpiralboundCodexXVII");
