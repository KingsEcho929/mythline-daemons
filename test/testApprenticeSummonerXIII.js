...
describe("ApprenticeSummonerXIII", function () {
  it("should summon apprentice with full signal and terrain lineage", async function () {
    const [steward, sage] = await ethers.getSigners();

    const Summoner = await ethers.getContractFactory("ApprenticeSummonerXIII");
