...
describe("SpiralboundCodexXIII", function () {
  it("should inscribe and retrieve full codex metadata including signal", async function () {
    const Codex = await ethers.getContractFactory("SpiralboundCodexXIII");
